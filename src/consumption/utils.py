...
def prepare_data_consumption_heating(rooms):
    ...
    consumptionByMonth = {"Jan": 250, "Feb": 224, "Mar": 203, "Apr": 180, "May": 132, "Jun": 90, "Jul": 69, "Aug": 74,
                          "Sep": 120,
...
def prepare_data_heating_price(prices):
    get_today_data = True
    all_dates = ["2023-12-21", "2023-12-14", "2023-12-07", "2023-11-30", "2023-11-23", "2023-11-16", "2023-11-09",
                 "2023-11-02", "2023-10-26", "2023-10-19", "2023-10-12", "2023-10-05", "2023-09-28", "2023-09-21",
                 "2023-09-14", "2023-09-07"]
    all_prices = ["0.91860", "0.87820", "0.93600", "0.97140", "0.96460", "0.98520", "1.00730", "1.01590", "1.02530",
                  "1.05890", "1.04030", "1.08120", "1.08340", "1.09890", "1.11860", "1.07120"]
    if prices.exists():
        all_dates.reverse()
        all_prices.reverse()
    ...
    if get_today_data:
        ...
        if response.status_code == 200:
            ...
            data_element = data_element.find('td', {'role': 'gridcell',
                                                    "style": "text-align: center;width:25%;border:none!important;"}).get_text(
                strip=True)
